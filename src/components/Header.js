    ...
    <>
		<div className="header__main" id="myTopnav">
			...
			<div className="header__menu" id="myMenu" onClick={RespMenu}>
				...
				<Link to="/Team" className="nav__links"><span>Team</span></Link>
				<Link to="/dsc-bkbiet-events" className="nav__links"><span>Events</span></Link>
				<Link to="/Blog" className="nav__links"><span>Blogs</span></Link>
				<Link to="/Podcasts" className="nav__links"><span>Podcasts</span></Link>
				<Link to="/contactUs" className="nav__links"><span>ContactUs</span></Link>
			</div>
		</div>
    </>
  );
